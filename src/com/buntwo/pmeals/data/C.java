...
public final class C {
	...
	// extra flags
	public static final String EXTRA_LOCATIONID = "com.buntwo.pmeals.LOCATIONID";
	public static final String EXTRA_LOCATIONNUMBER = "com.buntwo.pmeals.LOCATIONNUMBER";
	public static final String EXTRA_LOCATIONNAME = "com.buntwo.pmeals.LOCATIONNAME";
	public static final String EXTRA_MEALNAMES = "com.buntwo.pmeals.MEALNAMES";
	public static final String EXTRA_DATE = "com.buntwo.pmeals.DATE";
	public static final String EXTRA_ISREFRESH = "com.buntwo.pmeals.ISREFRESH";
	// NOTE: this is for an arraylist of ID's
	// the similarly named one above is for a single ID
	public static final String EXTRA_LOCATIONIDS = "com.buntwo.pmeals.LOCATIONIDS";
	// NOTE: similarly named one above
	public static final String EXTRA_MEALNAME = "com.buntwo.pmeals.MEALNAME";
	public static final String EXTRA_ISCURRENTMEAL = "com.buntwo.pmeals.ISCURRENTMEAL";
	public static final String EXTRA_MEALEXISTS = "com.buntwo.pmeals.MEALEXISTS";
    ...
    // intent actions
    public static final String ACTION_TIME_CHANGED = "com.buntwo.pmeals.action.TIME_CHANGED";
    public static final String ACTION_NEW_DAY = "com.buntwo.pmeals.action.NEW_DAY";
    public static final String ACTION_NEW_MEAL = "com.buntwo.pmeals.action.NEW_MEAL";
    public static final String ACTION_REFRESHSTART = "com.buntwo.pmeals.action.REFRESHSTART";
    public static final String ACTION_REFRESHDONE = "com.buntwo.pmeals.action.REFRESHDONE";
    public static final String ACTION_REFRESHFAILED = "com.buntwo.pmeals.action.REFRESHFAILED";
    public static final String ACTION_DATEFORMATTOGGLED = "com.buntwo.pmeals.action.DATEFORMATTOGGLED";
